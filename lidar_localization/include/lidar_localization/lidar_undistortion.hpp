#ifndef LIDAR_LOCALIZATION__LIDAR_UNDISTORTION_HPP_
#define LIDAR_LOCALIZATION__LIDAR_UNDISTORTION_HPP_
    ...
    const double imu_time)
  {
    ...
    if (time_diff < scan_period_) {
      imu_shift_x_[imu_ptr_last_] =
        imu_shift_x_[imu_ptr_back] + imu_velo_x_[imu_ptr_back] * time_diff +
        acc(0) * time_diff * time_diff * 0.5;
      imu_shift_y_[imu_ptr_last_] =
        imu_shift_y_[imu_ptr_back] + imu_velo_y_[imu_ptr_back] * time_diff +
        acc(1) * time_diff * time_diff * 0.5;
      imu_shift_z_[imu_ptr_last_] =
        imu_shift_z_[imu_ptr_back] + imu_velo_z_[imu_ptr_back] * time_diff +
...
#endif  // LIDAR_LOCALIZATION__LIDAR_UNDISTORTION_HPP_
