/*
@description:
This node let us robustly localize a LiDAR in a pre-built map using PCL registration methods.
*/
  ...
  broadcaster_(this)
{
  ...
  declare_parameter("enable_map_odom_tf", true);
  ...
  declare_parameter("scan_min_range", 2.0);
